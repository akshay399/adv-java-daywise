...
public class Servlet1 extends HttpServlet {
	...
	public Servlet1() {
		System.out.println("in def ctor : config : "+getServletConfig());//null, bcs servlett config is not yet created
//		System.out.println("context "+getServletContext());//what will happen ? NPE, wC creates servletContext as it is created at web deployment tme, but this will give null point exception since??
	}
