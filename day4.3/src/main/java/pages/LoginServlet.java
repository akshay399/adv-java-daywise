...
//Overriding form of the method CAN NOT add any NEW or BROADER CHECKED excs
	public LoginServlet(String mesg) {
		System.out.println("in parameterized ctor of the "+getClass());
		
	}
	public LoginServlet() {
		System.out.println("in default ctor of the "+getClass());
	...
	public void init() throws ServletException/* ,SQLException */ {
		try {
			...
			System.out.println("config in init "+config);//not null! : impl class name : catalina.jar
			// open cn
